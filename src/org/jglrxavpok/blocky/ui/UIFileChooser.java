...
public class UIFileChooser extends UIMenu implements TextChangeListener
{
	...
	public void initMenu()
	{
		...
		comps.add(okButton);
		cancelButton = new UIButton(this, w/2+10, 30, 200,20, Lang.getLocalized("filechooser.cancel"));
		comps.add(cancelButton);
		
		UILabel title = new UILabel(Lang.getLocalized("filechooser.title"), w/2,h-60, LabelAlignment.CENTERED);
