...
public class EntityPlayerClientMP extends EntityPlayer
{

    private boolean tPressed;

    public EntityPlayerClientMP()
    {
        super();
    ...
    public static class PlayerHUDComponent implements HUDComponent
    {
        ...
        public EntityPlayerClientMP player;
        
        public PlayerHUDComponent(EntityPlayerClientMP player)
        {
            this.player = player;
        }
