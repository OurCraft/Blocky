...
public class ClientPlayerInputHandler implements InputProcessor
{
    ...
    {
        this.player = entityPlayerClientMP;
    }
...
//                            }
                    ...
                    else
                    {
                        ...
                        NetworkCommons.sendPacketTo(new PacketBlockUpdate(tx,ty,BlockInfo.ATTACK_VALUE, multiplier+":"+player.username), false, BlockyMain.instance.getClientNetwork().getClientConnection());
//                        player.world.setAttackValue(tx, ty, player.world.getAttackValue(tx,ty)+multiplier, player.username);
                    }
                }
            }
